...
{
    [Authorize] //it will be use on global.asax
    public class EmployeesController : Controller
    {
        private OfficesEntities db = new OfficesEntities();
        ...
        [Authorize(Roles = "Farrukh,Customer")]
